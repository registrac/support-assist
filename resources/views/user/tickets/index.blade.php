...
<div class="my-4 mx-6 sm:mx-0 flex justify-end">
...
<div class="bg-white dark:bg-gray-900 overflow-hidden shadow-sm sm:rounded-lg mx-6 sm:mx-auto">
                ...
                @forelse ( $tickets as $ticket)
                    <tr class="text-sm">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <a href="{{ '/ticket/'.$ticket->id }}" class="text-indigo-600 dark:text-indigo-400 hover:text-indigo-900">
                                {{ __('View details') }}
                            </a>
                        </td>
                    </tr>
