<div>
    <div class="p-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <form wire:submit.prevent="updateCustomer" method="post">
                ...
                <div class="shadow rounded-md sm:overflow-hidden">
                    <div class="px-4 py-5 bg-white dark:bg-gray-900 space-y-6 sm:p-6">
                        ...
                        <div>
                            ...
                            <input wire:model.defer="name" name="name" type="text" value="{{ old('name') }}" class="form-input rounded-md shadow-sm mt-1 block w-full @error('name') border-red-300 @enderror">
                            @error('name')
                        ...
                        <div>
                            ...
                            <input wire:model.defer="email" name="email" type="email" value="{{ old('email') }}" class="form-input rounded-md shadow-sm mt-1 block w-full @error('email') border-red-300 @enderror">
                            @error('email')
                                <small class="text-sm text-red-800">
                                    {{ $message }}
                                </small>
                        ...
                        <div>
                            ...
                            <input wire:model.defer="tel" name="tel" type="tel" value="{{ old('tel') }}" class="form-input rounded-md shadow-sm mt-1 block w-full @error('tel') border-red-300 @enderror">
                            @error('tel')
                                <small class="text-sm text-red-800">
                                    {{ $message }}
                                </small>
                        ...
                        <div>
                            ...
                            <input wire:model.defer="postal_address" name="postal_address" type="text" value="{{ old('postal_address') }}" class="form-input rounded-md shadow-sm mt-1 block w-full @error('postal_address') border-red-300 @enderror">
                        ...
                        <div>
                            ...
                            <input wire:model.defer="stripe_id" name="stripe_id" type="text" value="{{ old('stripe_id') }}" class="form-input rounded-md shadow-sm mt-1 block w-full @error('stripe_id') border-red-300 @enderror">
                            @error('stripe_id')
